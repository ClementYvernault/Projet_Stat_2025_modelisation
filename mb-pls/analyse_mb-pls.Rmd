...
gap_stat <- clusGap(data_clust2,
                    FUN = kmeans,
                    nstart = 25, # centroids init random picks best
                    K.max = 15, # nombre max clusters
                    B = 100) # nombre iterations FUN
...
write_xlsx(km2_cluster4, 'mb-pls/km2/km2_cluster4.xlsx', col_names = TRUE,
           format_headers = TRUE,
           use_zip64 = FALSE)
...
write_xlsx(list(km2_cluster1, km2_cluster2, km2_cluster3, km2_cluster4), 'mb-pls/km2/Clusters_km2.xlsx', col_names = TRUE,
           format_headers = TRUE,
           use_zip64 = FALSE)
```


### Clustering K-means avec 4 dimensions et coupure en 3 clusters
...
### Clustering K-means avec 6 dimensions et coupure en 3 clusters 
...
### Clustering K-means avec 10 dimensions et coupure en 3 clusters 
